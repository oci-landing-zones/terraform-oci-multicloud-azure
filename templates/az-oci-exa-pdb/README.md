...
exadata_infrastructure_name                                      = "ExadataInfrastructure"
zones                                                            = "3"
...
| exadata_infrastructure_name                             | The name of the Exadata Infrastructure on Azure."                                                                                                                                                                                                                                                                    | `string` | n/a     |   yes    |
| zones                                                            | The zone of the Exadata Infrastructure for Azure.                                                                                                                                                                                                                                                                    | `string` | n/a     |   yes    |
| vm_cluster_name                                         | The name of a VM Cluster on Azure.                                                                                                                                                                                                                                                                          | `string` | n/a     |   yes    |
